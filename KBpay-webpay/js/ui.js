    ...
    $(document).ready(function() {
        ...
        */
            ...
            $(".l-bottom").each(function() {
                ...
                // 하단 버튼 x
                    ...
                    if (($(window).height() - 16) < $(this).height()) {
                        $(this).find(".l-bottom-wrap .l-contents").height( $(window).height() - 32 - $(this).find(".l-bottom-wrap .head").innerHeight());
                        $(this).find(".l-bottom-wrap .l-contents").addClass("scroll");
                    }
                }
            });
        ...
        $(".l-bottom .bottom-list button").click(function() {
            ...
            // bottom sheet down
            $(".curBottom").stop().animate({
                bottom: -($(".curBottom").height())
            }, 200, 'swing', function() {
                //after animate
